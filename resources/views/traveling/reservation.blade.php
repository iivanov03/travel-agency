                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <fieldset>
                                ...
                                <select name="num_guest" class="form-select" aria-label="Default select example" id="chooseGuests">
                        ...
                        <div class="col-lg-12">
                            <fieldset>
                                <label for="chooseDestination" class="form-label">Destination</label>
                                <input disabled type="text" value="{{$city->name}}" name="destination" class="Name" required>
                            </fieldset>
                        </div>
                        <div class="col-lg-12">
                            <fieldset>
                                ...
                                @else 
                                <p class="alert alert-warning">Login first, to be able to book.</p>
                                @endif
                            </fieldset>
                        </div>
                    </div>
